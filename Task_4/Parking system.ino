...
void loop()
{
  ...
  float p1 = 0.01724* readDistance(t1, t1);
  float p2 = 0.01724* readDistance(t2, t2);
  float p3 = 0.01724* readDistance(t3, t3);

  
  Serial.println("Distance of the vehicle at pking space 1 -" +String(p1)+"cm");
  Serial.println("Distance of the vehicle at pking space 2 -" +String(p2)+"cm");
  Serial.println("Distance of the vehicle at pking space 3 -" +String(p3)+"cm");
